...
;(function () {
  ...
  function hashObj() {
    var retObj = {};
    var hashArr = location.hash.slice(1).split('&').forEach(function (item) {
    ...
    created: function created() {
      ...
      new Promise(function (r, j) {
        fetch(emojiUrl).then(function (res) {
          ...
          _this2.pagination.current = page - 1;
        });
      });
    }
  };
...
__vue__options__.staticRenderFns = [function render() {
  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('footer', [_vm._v("\n        Emoji data from "), _c('a', { attrs: { "href": "https://gist.githubusercontent.com/oliveratgithub/0bf11a9aff0d6da7b46f1490f86a71eb/" } }, [_vm._v("Emojis.json")]), _vm._v(" - \n        Made with ❤ By "), _c('a', { attrs: { "href": "https://geeku.net/" } }, [_vm._v("Geeku")])]);
}];
if (module.hot) {
  (function () {
    ...
    module.hot.accept();
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-1b8901fd", __vue__options__);
    } else {
      hotAPI.reload("data-v-1b8901fd", __vue__options__);
    }
  })();
}
},{"vue":8,"vueify/lib/insert-css":9,"vue-hot-reload-api":10}],6:[function(require,module,exports) {
"use strict";
